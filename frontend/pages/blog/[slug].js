  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={getImageUrl(blog.featured_image, DEFAULT_IMAGES.ARTICLE_THUMBNAIL)} />
        ...
        {blog.featured_image && (
          <link
            rel="preload"
            href={getImageUrl(blog.featured_image)}
            as="image"
                  ...
                  <article key={article.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <Link href={`/blog/${article.slug}`}>
                      <div className="aspect-video relative">
                        <img
                          src={getImageUrl(article.featured_image, DEFAULT_IMAGES.ARTICLE_THUMBNAIL)}
                          alt={article.title}
